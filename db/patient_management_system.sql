...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2020 at 09:54 AM
...
(1, '04/25/2020', 'feeling tired, cant eat, vomiting and tooth pains', 'teeth issues', '1', 'Dental', 'Pending'),
(2, '04/25/2020', 'vomiting, tooth pains', 'tooth problem', '25', 'Dental', 'Pending');
...
('1', '', '', 'Suka', '', 'George', '11/21/1970', 36, 'Kumasi', 'Single', 'Male', '133', '120°C', '12.4', '233', '90kg', '5.6'),
('25', '', '', 'Sinaman', '', 'Matthew', '02/21/1990', 30, 'Takoradi', 'Single', 'Male', '120', '45&deg;C', '1234', '435', '123kg', '4.6');
...
(1, 'admin', '1234', 'George', '', 'Suka', 'admin'),
(3, 'sinaman', '1234', 'Sinnaman', '', 'Mathew', 'Dental'),
(6, 'daniel', '5161570077', 'Daniel', '', 'Kakou', 'admin'),
(7, 'frank', '5161570063', 'Frank', '', 'Oppong', 'Maternity');
...
--
ALTER TABLE `complaints`
  MODIFY `com_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
