<?php
	...
	if(ISSET($_POST['edit_admin'])){
			...
			$lastname = $_POST['lastname'];
			$conn = new mysqli("localhost", "root", "", "patient_management_system") or die(mysqli_error());
			$conn->query("UPDATE `user` SET `username` = '$username', `password` = '$password', `firstname` = '$firstname', `middlename` = '$middlename', `lastname` = '$lastname' WHERE `user_id` = '$id'") or die(mysqli_error());
